...
class SushiItemService:
    @staticmethod
    def create(name, price, category=None):
        return SushiItemRepository.add(name, float(price), category)
    ...
    @staticmethod
    def update(item_id: int, name=None, price=None, category=None):
        return SushiItemRepository.update(item_id, name, price, category)
